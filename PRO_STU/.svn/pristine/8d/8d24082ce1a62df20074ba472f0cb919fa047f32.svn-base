...
class myTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testDirName() {
        $dirObject = new DirectoryClass("/test", "1234", "hzhang91", "03-02-2013");
        $subDir = new DirectoryClass("/test/sub", "1234", "hzhang91", "03-02-2015");
    ...
    public function testAuthor() {
        $dirObject = new DirectoryClass("/test", "1234", "hzhang91", "03-04-2015");
        $subDir = new DirectoryClass("/test/sub", "1234", "hzhang91", "03-04-2015");
        $dirObject -> addSubDir("mySub", $subDir);
        $subArray = $dirObject -> getSubDirArray();
        $dirAuthor = null;
        foreach ($subArray as $name => $object){
    ...
    public function testinput() {
        ...
        $subDir = new DirectoryClass("/test/sub", "1234", "hzhang91", "02-06-2014");
        $dirObject -> addSubDir("mySub", $subDir);
        $subArray = $dirObject -> getSubDirArray();
        $dirName = null;
        foreach ($subArray as $name => $object){
